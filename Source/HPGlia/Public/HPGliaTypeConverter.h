...
public:
    ...
    { 
        return HP::Omnicept::Abi::MessageTypeUtils::getEnumForType<typename Ue4ToGliaMap<Ue4DomainType>::GliaType>();
    };

    template<class Ue4DomainType> static FString getTypeName()
    { 
        return FString( HP::Omnicept::Abi::MessageTypeUtils::getTypeName<typename Ue4ToGliaMap<Ue4DomainType>::GliaType>().c_str()); 
    }
};
