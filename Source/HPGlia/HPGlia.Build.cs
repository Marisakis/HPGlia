...
// Edited 2024 Sebastiaan Colijn, error throw for no HPGlia installation found
...
public class HPGlia : ModuleRules
{
    ...
    private string ThirdPartyPath
    {
        get
        {
            ...
            if(gliaInstallPath != null)
            {
                return Path.GetFullPath(gliaInstallPath);
            }
            else
            { 
                throw new System.NullReferenceException("HPGlia Environment Variable not found, are you sure it's installed?");
            }
        }
    }
    ...
    public HPGlia(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Win64)
        {
            ...
            {
                throw new System.IO.FileNotFoundException("DLL files not found in HPGlia Binaries folder");
            }
    }
    }
}
